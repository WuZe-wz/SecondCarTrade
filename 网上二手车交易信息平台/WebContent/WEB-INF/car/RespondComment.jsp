...
<form action ="${pageContext.request.contextPath}/AddResondComment.car?carid=${requestScope.car.carid }&userid=${requestScope.car.userid}&respondid=${requestScope.respondid }" method="post">
		...
		留言：<textarea name="carcomment"  style="width:300px;height:100px;border: 1px solid #99ccff;" >${requestScope.car.carcomment}*****userid ${requestScope.respondid }:</textarea><br><br>
